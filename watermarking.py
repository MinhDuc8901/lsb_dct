...
#        dwt_img = cv2.imread(original_image_file, cv2.IMREAD_UNCHANGED)
        # key_encoded = input("Enter the key you want to encrypt: ")
        ...
        dct_img_encoded = DCT().encode_image(dct_img, code_text)
...
#        dwt_hidden_text = DWT().decode_image(dwt_img) 
        ...
        file.write(str(decrypt_aes(b'ThisIsA16ByteKey',dct_hidden_text))) # saving hidden text as text file
        file.close()
